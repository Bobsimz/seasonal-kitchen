...
public class SearchController {
 ...
 public ApiResponse<SearchResponse> search(@RequestParam @NotBlank String q,@RequestParam(defaultValue="ALL") @Pattern(regexp="ALL|INGREDIENT|RECIPE") String type){return ApiResponse.success(service.search(q,type,currentUserId()),null);}
