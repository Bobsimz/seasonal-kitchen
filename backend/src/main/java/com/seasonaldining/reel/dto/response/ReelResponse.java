...
public record ReelResponse(
        ...
        @Schema(description = "크리에이터 아바타 URL", nullable = true) String creatorAvatarUrl,
        ...
        @Schema(description = "재료 태그") List<String> ingredientTags,
        ...
        @Schema(description = "조회 수", example = "1240000") long viewCount,
